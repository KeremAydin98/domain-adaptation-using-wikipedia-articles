...
class ModelTraining:
    ...
    def __init__(self):
        ...
        self.wandb_project = 'final-experiments'
    ...
    def training_run(self, attn_implementation=None):
        ...
        model_args, data_args, training_args = parser.parse_args_into_dataclasses(args_filename='/mnt/keremaydin/llava/run_script_med.sh')
